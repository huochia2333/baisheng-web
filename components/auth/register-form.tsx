...
export function RegisterForm() {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <Button
        className="mt-2 h-[58px] w-full rounded-[20px] bg-[#486782] text-base font-semibold text-white shadow-[0_10px_30px_rgba(72,103,130,0.28)] transition-all hover:bg-[#3f5f78]"
        disabled={submitting}
        type="submit"
      >
